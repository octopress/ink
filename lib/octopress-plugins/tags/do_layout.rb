...
module Jekyll
  class PluginHooks < PageHooks
    ...
    def pre_render(page)
      ...
      # Does the plugin layout match the right format? (theme/layout-name or plugin-name/layout-name)
      elsif data['plugin_layout'] && data['plugin_layout'] =~ Octopress::Tags::DoLayoutTag::LAYOUT_VAR
